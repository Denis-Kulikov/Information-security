...
public:
    ...
    static std::pair<long long, long long> signWithRSA(const std::string& filename);
    static bool verifyWithRSA(const std::string& filename, std::pair<long long, long long> keys);
